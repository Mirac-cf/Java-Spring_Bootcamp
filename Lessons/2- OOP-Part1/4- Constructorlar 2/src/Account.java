...
public class Account {
    ...
    public void BilgileriGöster(){
        ...
        System.out.println("İsim: " + isim +     // this.isim dememize gerek yok java bunun isim özelliği olduğunu anlıyor
                           "\nHesap no: " + hesapNo +
                           "\nBakiye: "+ bakiye + 
                           "\nGmail: " + gmail + 
    ...
    public void paraYatır(double miktar){
        bakiye += miktar;    // burda  this.bakiye demedik çünkü bakiye sabit miktarla bişi
